...
{
    public class NLogPrimaryFactory : PrimaryFactoryWinForms
    {
    ...
    public class AnalogyNLogDataProviderFactory : DataProvidersFactoryWinForms
    {
    ...
    {
        public Guid FactoryId { get; set; } = NLogPrimaryFactory.Id;
